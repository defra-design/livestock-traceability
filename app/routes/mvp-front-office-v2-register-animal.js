...
const BASE = '/mvp-front-office/v2/register-animal'
...
router.get(`${BASE}/animal-select`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/animal-select')
})
...
router.post(`${BASE}/animal-select`, (req, res) => {
  ...
  if (!animalType) {
    return res.render('mvp-front-office/v2/register-animal/animal-select', {
      errors: {
  ...
  res.redirect('/mvp-front-office/v2/report-death/is-registered')
})

router.get(`${BASE}/submission-type`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/submission-type')
})
...
router.post(`${BASE}/submission-type`, (req, res) => {
  ...
  if (!submissionType) {
    return res.render('mvp-front-office/v2/register-animal/submission-type', {
...
router.get(`${BASE}/calf-details`, (req, res) => {
  ...
  res.render('mvp-front-office/v2/register-animal/calf-details')
})
...
router.post(`${BASE}/calf-details`, (req, res) => {
  ...
  if (Object.keys(errors).length > 0) {
    return res.render('mvp-front-office/v2/register-animal/calf-details', { errors })
  }
...
router.get(`${BASE}/dam-details`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/dam-details')
})
...
router.post(`${BASE}/dam-details`, (req, res) => {
  ...
  if (!data['dam-type']) {
    return res.render('mvp-front-office/v2/register-animal/dam-details', {
...
router.get(`${BASE}/surrogate-dam`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/surrogate-dam')
})
...
router.post(`${BASE}/surrogate-dam`, (req, res) => {
  ...
  if (Object.keys(errors).length > 0) {
    return res.render('mvp-front-office/v2/register-animal/surrogate-dam', { errors })
  }
...
router.get(`${BASE}/genetic-dam`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/genetic-dam')
})

router.post(`${BASE}/genetic-dam`, (req, res) => {
  const data = req.session.data
  if (!data['genetic-dam-number']) {
    return res.render('mvp-front-office/v2/register-animal/genetic-dam', {
      errors: { 'genetic-dam-number': 'Enter the ear tag number of the genetic dam' }
    })
  }
  returnToCheck(req, res, `${BASE}/sire-details`)
...
router.get(`${BASE}/sire-details`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/sire-details')
})
...
router.get(`${BASE}/check-calf-details`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/check-calf-details')
})
...
router.get(`${BASE}/remove-calf`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/remove-calf')
})
...
router.get(`${BASE}/tag-list`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/tag-list')
})
...
router.post(`${BASE}/tag-list`, (req, res) => {
  ...
  if (Object.keys(errors).length > 0) {
    return res.render('mvp-front-office/v2/register-animal/tag-list', { errors })
  }
...
router.get(`${BASE}/submit`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/submit')
})
...
router.get(`${BASE}/confirmation`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/confirmation')
})

router.post(`${BASE}/confirmation`, (req, res) => {
  res.redirect('/mvp-front-office/v2/my-holdings/submissions')
})

router.get(`${BASE}/submission-detail`, (req, res) => {
  res.render('mvp-front-office/v2/register-animal/submission-detail')
})
