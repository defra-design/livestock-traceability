...
const BASE = '/report-and-view-alpha/v1/register-animal'
...
router.get(`${BASE}/animal-select`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/animal-select')
})
...
router.post(`${BASE}/animal-select`, (req, res) => {
  ...
  if (!animalType) {
    return res.render('report-and-view-alpha/v1/register-animal/animal-select', {
      errors: {
  ...
  res.redirect('/report-and-view-alpha/v1/report-death/is-registered')
})

router.get(`${BASE}/submission-type`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/submission-type')
})
...
router.post(`${BASE}/submission-type`, (req, res) => {
  ...
  if (!submissionType) {
    return res.render('report-and-view-alpha/v1/register-animal/submission-type', {
...
router.get(`${BASE}/calf-details`, (req, res) => {
  ...
  res.render('report-and-view-alpha/v1/register-animal/calf-details')
})
...
router.post(`${BASE}/calf-details`, (req, res) => {
  ...
  if (Object.keys(errors).length > 0) {
    return res.render('report-and-view-alpha/v1/register-animal/calf-details', { errors })
  }
...
router.get(`${BASE}/dam-details`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/dam-details')
})
...
router.post(`${BASE}/dam-details`, (req, res) => {
  ...
  if (!data['dam-type']) {
    return res.render('report-and-view-alpha/v1/register-animal/dam-details', {
...
router.get(`${BASE}/surrogate-dam`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/surrogate-dam')
})
...
router.post(`${BASE}/surrogate-dam`, (req, res) => {
  ...
  if (Object.keys(errors).length > 0) {
    return res.render('report-and-view-alpha/v1/register-animal/surrogate-dam', { errors })
  }
...
router.get(`${BASE}/genetic-dam`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/genetic-dam')
})
...
router.post(`${BASE}/genetic-dam`, (req, res) => {
  ...
  if (error) {
    return res.render('report-and-view-alpha/v1/register-animal/genetic-dam', {
...
router.get(`${BASE}/sire-details`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/sire-details')
})
...
router.get(`${BASE}/check-calf-details`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/check-calf-details')
})
...
router.get(`${BASE}/remove-calf`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/remove-calf')
})
...
router.get(`${BASE}/tag-list`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/tag-list')
})
...
router.post(`${BASE}/tag-list`, (req, res) => {
  ...
  if (Object.keys(errors).length > 0) {
    return res.render('report-and-view-alpha/v1/register-animal/tag-list', { errors })
  }
...
router.get(`${BASE}/submit`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/submit')
})
...
router.get(`${BASE}/confirmation`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/confirmation')
})

router.post(`${BASE}/confirmation`, (req, res) => {
  res.redirect('/report-and-view-alpha/v1/my-holdings/submissions')
})

router.get(`${BASE}/submission-detail`, (req, res) => {
  res.render('report-and-view-alpha/v1/register-animal/submission-detail')
})
