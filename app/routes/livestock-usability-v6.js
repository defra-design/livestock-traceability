...
router.post('/livestock-usability/v6/registration-method', (req, res) => {
  const method = req.session.data['registration-method']
  if (method === 'file-upload') {
    res.redirect('/livestock-usability/v6/file-upload')
  } else {
...
router.post('/livestock-usability/v6/upload', (req, res) => {
  res.redirect('/livestock-usability/v6/tag-list')
})

router.post('/livestock-usability/v6/tag-entry', (req, res) => {
  res.redirect('/livestock-usability/v6/tag-list')
})

router.post('/livestock-usability/v6/tag-list', (req, res) => {
  ...
  if (Object.keys(errors).length > 0) {
    return res.render('livestock-usability/v6/register-animal/tag-list', { errors })
  }

  if (addAnother === 'yes') {
    return res.redirect('/livestock-usability/v6/calf-details')
  }

  res.redirect('/livestock-usability/v6/submit')
})

router.get('/livestock-usability/v6/calf-details', (req, res) => {
  if (req.query.tag) {
    req.session.data['current-tag'] = req.query.tag
  }
  res.render('livestock-usability/v6/register-animal/calf-details')
})

router.post('/livestock-usability/v6/calf-details', (req, res) => {
  const data = req.session.data
  const errors = {}
...
router.post('/livestock-usability/v6/calf-details-radio', (req, res) => {
...
router.post('/livestock-usability/v6/multiple-birth', (req, res) => {
  res.redirect('/livestock-usability/v6/breed')
})

router.post('/livestock-usability/v6/dam-details', (req, res) => {
  const data = req.session.data

  if (!data['dam-type']) {
    return res.render('livestock-usability/v6/register-animal/dam-details', {
