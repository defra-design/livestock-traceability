...
const BASE = '/mvp-front-office/v2/manage-delegates'
const LIST_PAGE = '/mvp-front-office/v2/my-holdings/manage-delegates'
...
router.get(`${BASE}/add-email`, (req, res) => {
  ...
  res.render('mvp-front-office/v2/manage-delegates/add-email')
})
...
router.post(`${BASE}/add-email`, (req, res) => {
  ...
  if (!email || !email.trim()) {
    return res.render('mvp-front-office/v2/manage-delegates/add-email', {
...
router.get(`${BASE}/add-role`, (req, res) => {
  res.render('mvp-front-office/v2/manage-delegates/add-role')
})

router.post(`${BASE}/add-role`, (req, res) => {
  if (!req.session.data['delegate-role']) {
    return res.render('mvp-front-office/v2/manage-delegates/add-role', {
...
router.get(`${BASE}/before-you-send`, (req, res) => {
  res.render('mvp-front-office/v2/manage-delegates/before-you-send')
})
...
router.get(`${BASE}/check-details`, (req, res) => {
  ...
  res.render('mvp-front-office/v2/manage-delegates/check-details', { holding, isUpdate })
})
...
router.get(`${BASE}/confirmation`, (req, res) => {
  res.render('mvp-front-office/v2/manage-delegates/confirmation')
})
...
router.get(`${BASE}/remove-delegate`, (req, res) => {
  res.render('mvp-front-office/v2/manage-delegates/remove-delegate')
})
