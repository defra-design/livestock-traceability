...
const BASE = '/mvp-front-office/v3/report-death'
...
router.post(`${BASE}/is-registered`, (req, res) => {
  ...
  if (!answer) {
    return res.render('mvp-front-office/v3/report-death/is-registered', {
...
router.post(`${BASE}/yes/animal-details`, (req, res) => {
  ...
  if (Object.keys(errors).length > 0) {
    return res.render('mvp-front-office/v3/report-death/yes/animal-details', { errors })
  }
...
router.post(`${BASE}/no/animal-details`, (req, res) => {
  ...
  if (Object.keys(errors).length > 0) {
    return res.render('mvp-front-office/v3/report-death/no/animal-details', { errors })
  }
...
router.post(`${BASE}/add-more-deaths`, (req, res) => {
  ...
  if (!answer) {
    return res.render('mvp-front-office/v3/report-death/add-more-deaths', {
