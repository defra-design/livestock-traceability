...
router.post('/cattle-birth-registration-alpha/auth/one-login-email', (req, res) => {
  res.redirect('/cattle-birth-registration-alpha/auth/one-login-password')
})

router.post('/cattle-birth-registration-alpha/auth/one-login-password', (req, res) => {
  res.redirect('/cattle-birth-registration-alpha/auth/check-your-phone')
})

router.post('/cattle-birth-registration-alpha/auth/check-your-phone', (req, res) => {
  res.redirect('/cattle-birth-registration-alpha/overview')
})

router.get('/cattle-birth-registration-alpha/my-holdings/holding-details', (req, res) => {
  const holding = getSelectedHolding(req)

  res.render('cattle-birth-registration-alpha/my-holdings/holding-details', { holding })
})

router.get('/cattle-birth-registration-alpha/my-holdings/holding-overview', (req, res) => {
  const holding = getSelectedHolding(req)
  ...
  res.render('cattle-birth-registration-alpha/my-holdings/holding-overview', { holding, cattle, errorRecordsCount })
})

router.get('/cattle-birth-registration-alpha/my-holdings', (req, res) => {
  const holdingsData = req.session.data.holdingsSingleCph
  ...
  res.render('cattle-birth-registration-alpha/my-holdings', { holdings, search })
})

router.get('/cattle-birth-registration-alpha/my-holdings/submissions', (req, res) => {
  const holding = getSelectedHolding(req)

  res.render('cattle-birth-registration-alpha/my-holdings/submissions', { holding })
})

router.get('/cattle-birth-registration-alpha/my-holdings/animals-on-holding', (req, res) => {
  const search = String(req.query.search || '').trim().toLowerCase()
  const cattleData = req.session.data.livestockSameHerd
  const holding = getSelectedHolding(req)
  ...
  const pageHref = (pageNumber) => {
    ...
    return `/cattle-birth-registration-alpha/my-holdings/animals-on-holding?${params.toString()}`
  }
  ...
  res.render('cattle-birth-registration-alpha/my-holdings/animals-on-holding', {
    cattle: pagedCattle,
    search,
    holding,
    pagination,
...
router.get('/cattle-birth-registration-alpha/my-holdings/export-animals', (req, res) => {
  const holding = getSelectedHolding(req)
  const exported = req.query.exported === 'true'

  res.render('cattle-birth-registration-alpha/my-holdings/export-animals', { holding, exported })
})

router.post('/cattle-birth-registration-alpha/my-holdings/export-animals', (req, res) => {
  res.redirect('/cattle-birth-registration-alpha/my-holdings/export-animals?exported=true')
})

router.get('/cattle-birth-registration-alpha/my-holdings/animal-error-record', (req, res) => {
  const holding = getSelectedHolding(req)
  ...
  const pageHref = (pageNumber) => {
    ...
    params.set('page', pageNumber)
    return `/cattle-birth-registration-alpha/my-holdings/animal-error-record?${params.toString()}`
  }
  ...
  res.render('cattle-birth-registration-alpha/my-holdings/animal-error-record', {
    errors: pagedErrors,
    sort,
    pagination,
    showingFrom,
...
router.get('/cattle-birth-registration-alpha/my-holdings/animal-error-record/:id', (req, res) => {
  const holding = getSelectedHolding(req)
  ...
  res.render('cattle-birth-registration-alpha/my-holdings/animal-error-record-detail', { record, holding })
})

router.get('/cattle-birth-registration-alpha/my-holdings/activity-history', (req, res) => {
  const holding = getSelectedHolding(req)

  res.render('cattle-birth-registration-alpha/my-holdings/activity-history', { holding })
})

router.get('/cattle-birth-registration-alpha/my-holdings/messages', (req, res) => {
  const holding = getSelectedHolding(req)

  res.render('cattle-birth-registration-alpha/my-holdings/messages', { holding })
})

router.get('/cattle-birth-registration-alpha/my-holdings/manage-delegates', (req, res) => {
  const holding = getSelectedHolding(req)

  const delegates = [...req.session.data.delegatesSingleCph.delegates]
    .sort((a, b) => new Date(b.dateAdded) - new Date(a.dateAdded))

  res.render('cattle-birth-registration-alpha/my-holdings/manage-delegates', { holding, delegates })
})

router.get('/cattle-birth-registration-alpha/my-holdings/cattle/:earTagNumber', (req, res) => {
  const cattleData = req.session.data.livestockSameHerd
  const holding = getSelectedHolding(req)
  ...
  res.render('cattle-birth-registration-alpha/my-holdings/animal-details', { animal, offspring, holding })
})

router.get('/cattle-birth-registration-alpha/my-holdings/cattle/:earTagNumber/activity-record', (req, res) => {
  const cattleData = req.session.data.livestockSameHerd
  const holding = getSelectedHolding(req)
  ...
  res.render('cattle-birth-registration-alpha/my-holdings/animal-activity-record', { animal, holding, transactions })
})
